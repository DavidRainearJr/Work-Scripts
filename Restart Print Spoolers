...
   sc.exe \\DPRO1 stop spooler && sc.exe \\DPRO1 start spooler
   sc.exe \\DPRO7 stop spooler && sc.exe \\DPRO7 start spooler
   sc.exe \\DPRO5 stop spooler && sc.exe \\DPRO5 start spooler
   sc.exe \\DPRO11 stop spooler && sc.exe \\DPRO11 start spooler
